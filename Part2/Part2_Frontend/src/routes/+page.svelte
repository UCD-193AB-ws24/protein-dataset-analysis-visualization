...
<div class="landing">
	...
	<div class="content">
		...
		<div class="buttons">
			<button on:click={startLogin}>Sign in with AWS</button>
		</div>
	</div>
</div>
...
<style>
	...
	.landing {
		...
		padding: 2rem;
		text-align: center;
		background: url('https://images.unsplash.com/photo-1612178993494-1c2d1f1c9376?auto=format&fit=crop&w=1950&q=80')
